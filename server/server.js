...
const whitelist = ['http://localhost:8080', 'https://nola-paddle-trails.netlify.app', 'https://kayakneworleans.com', 'https://www.kayakneworleans.com/'];

const corsOpts = {
  credentials: true,
  origin: 'https://www.kayakneworleans.com/'
}
